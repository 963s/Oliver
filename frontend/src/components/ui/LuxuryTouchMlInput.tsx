    ...
    <div className="flex w-full max-w-md flex-col gap-3">
      <div className="flex items-stretch gap-2">
        <button
          ...
          className="flex min-h-[56px] min-w-[56px] shrink-0 items-center justify-center rounded-xl border border-deep-charcoal/10 bg-gray-200/55 text-3xl font-light leading-none text-deep-charcoal shadow-[0_0_28px_rgba(212,175,55,0.08)] backdrop-blur-xl transition hover:border-champagne-gold/25 hover:shadow-[0_0_36px_rgba(212,175,55,0.14)] active:scale-[0.97]"
          onClick={() => bump(-step)}
        >
          −
        </button>
        <div className="flex min-h-[56px] min-w-0 flex-1 flex-col items-center justify-center rounded-xl border border-deep-charcoal/10 bg-gray-200/50 px-2 py-2 text-center shadow-[inset_0_0_0_1px_rgba(0,0,0,0.06)] backdrop-blur-xl">
      ...
      <div className="flex items-stretch gap-2">
        <button
          ...
          className="flex min-h-[44px] flex-1 items-center justify-center rounded-xl border border-deep-charcoal/10 bg-gray-200/40 text-lg font-semibold text-deep-charcoal/90 backdrop-blur-md transition hover:bg-gray-200/70 active:scale-[0.98]"
